...
plant_params = pd.read_csv(os.path.join(script_dir, 'Plant_Parameters.csv'))
...
background_image = tk.PhotoImage(file=os.path.join(script_dir, "crop_prediction_bg 1.png"))
